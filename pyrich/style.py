...
def style_terminal_text(text, color: Optional[str]=None, style: Optional[str]=None) -> str:
    ansi_styles = {
        None: '',
        'black': '\033[30m',
        'red': '\033[31m',
    ...
    styled_text = f"{ansi_styles[style]}{ansi_styles[color]}{text}{ansi_styles['end']}"
    return styled_text
